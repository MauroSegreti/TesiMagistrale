"""
Come main.py, ma con la griglia di pT estesa fino a 3 TeV (PT_BINS_EXT
qui sotto, 14 bin, al posto dei 6 di config.py che arrivano solo a 500
...
def main(input_path):
    ...
    print(f"[INFO] Muoni riempiti negli istogrammi (pT 20-3000 GeV) = {filled_muons}")
