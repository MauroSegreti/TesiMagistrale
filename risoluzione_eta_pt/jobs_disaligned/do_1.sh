...
WORK=/eos/user/m/masegret/risoluzione_eta_disaligned_out/job_1
mkdir -p $WORK
cd $WORK

python3 /afs/cern.ch/user/m/masegret/TesiMagistrale/risoluzione_eta_pt/main.py root://grid-dc.t2.mpcdf.mpg.de:1094//atlasgroupdisk/perf-muons/rucio/user/lucam/3f/92/user.lucam.50435891._000002.ANALYSIS.root
echo "Exit code: $?"
