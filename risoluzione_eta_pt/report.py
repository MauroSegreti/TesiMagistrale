...
def build_table_pdf(results, filename="table_RMS_vs_eta.pdf"):
    ...
    c = ROOT.TCanvas("c_table", "Results table", 850, 1150)
    ...
    title.DrawLatex(0.5, 0.965, "p_{T} resolution RMS")
    ...
    subtitle.DrawLatex(0.5, 0.945, "per p_{T} and |#eta^{truth}| bin -- prompt truth muons only (IFFType == 4)")
    ...
    footer.DrawLatex(0.5, max(table_bottom - 0.025, 0.015),
                      "Automatically generated by main.py -- risoluzione_eta_pt")
