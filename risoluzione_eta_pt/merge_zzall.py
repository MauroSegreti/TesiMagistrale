"""
Unisce gli output dei 73 job (68 Z aligned + 5 Z' aligned, griglia pT
estesa a 3 TeV) e genera gli stessi plot/tabella di images/ ma sulla
statistica combinata, in ZZallRMS/.

Uso:
    python3 merge_zzall.py /eos/user/m/masegret/risoluzione_zzall_out
"""
...
from main_zzall import PT_BINS_EXT
import histograms
import plotting
import report
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Uso: python3 merge_zzall.py <outdir>")
        sys.exit(1)
    main(sys.argv[1])
