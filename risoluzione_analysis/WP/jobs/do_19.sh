...
python3 /afs/cern.ch/user/m/masegret/TesiMagistrale/risoluzione_analysis/WP/main.py /eos/user/m/masegret/PerfectAlignment/user.lucam.mc23_13p6TeV.601190.PhPy8EG_AZNLO_Zmumu.MCP_TESTNTUP.mc23e_ANALYSIS.root/user.lucam.51077380._000020.ANALYSIS.root
echo "Exit code: $?"
